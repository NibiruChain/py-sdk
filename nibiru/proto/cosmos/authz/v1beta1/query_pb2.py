...
QueryGrantsRequest = _reflection.GeneratedProtocolMessageType(
    'QueryGrantsRequest',
    (_message.Message,),
    {
...
QueryGrantsResponse = _reflection.GeneratedProtocolMessageType(
    'QueryGrantsResponse',
    (_message.Message,),
    {
...
QueryGranterGrantsRequest = _reflection.GeneratedProtocolMessageType(
...
QueryGranterGrantsResponse = _reflection.GeneratedProtocolMessageType(
...
QueryGranteeGrantsRequest = _reflection.GeneratedProtocolMessageType(
...
QueryGranteeGrantsResponse = _reflection.GeneratedProtocolMessageType(
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _QUERY.methods_by_name[
        'Grants'
    ]._serialized_options = b'\202\323\344\223\002\036\022\034/cosmos/authz/v1beta1/grants'
    _QUERY.methods_by_name['GranterGrants']._options = None
    _QUERY.methods_by_name[
        'GranterGrants'
    ]._serialized_options = b'\202\323\344\223\0020\022./cosmos/authz/v1beta1/grants/granter/{granter}'
    _QUERY.methods_by_name['GranteeGrants']._options = None
    _QUERY.methods_by_name[
        'GranteeGrants'
    ]._serialized_options = b'\202\323\344\223\0020\022./cosmos/authz/v1beta1/grants/grantee/{grantee}'
