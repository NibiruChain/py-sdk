...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _GENESISSTATE.fields_by_name[
        'signing_infos'
    ]._serialized_options = b'\362\336\037\024yaml:\"signing_infos\"\310\336\037\000'
    _GENESISSTATE.fields_by_name['missed_blocks']._options = None
    _GENESISSTATE.fields_by_name[
        'missed_blocks'
    ]._serialized_options = b'\362\336\037\024yaml:\"missed_blocks\"\310\336\037\000'
    _SIGNINGINFO.fields_by_name['validator_signing_info']._options = None
    _SIGNINGINFO.fields_by_name[
        'validator_signing_info'
    ]._serialized_options = b'\310\336\037\000\362\336\037\035yaml:\"validator_signing_info\"'
    _VALIDATORMISSEDBLOCKS.fields_by_name['missed_blocks']._options = None
    _VALIDATORMISSEDBLOCKS.fields_by_name[
        'missed_blocks'
    ]._serialized_options = b'\310\336\037\000\362\336\037\024yaml:\"missed_blocks\"'
