...
QueryAllowanceRequest = _reflection.GeneratedProtocolMessageType(
...
QueryAllowanceResponse = _reflection.GeneratedProtocolMessageType(
...
QueryAllowancesRequest = _reflection.GeneratedProtocolMessageType(
...
QueryAllowancesResponse = _reflection.GeneratedProtocolMessageType(
...
QueryAllowancesByGranterRequest = _reflection.GeneratedProtocolMessageType(
...
QueryAllowancesByGranterResponse = _reflection.GeneratedProtocolMessageType(
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _QUERY.methods_by_name[
        'Allowance'
    ]._serialized_options = b'\202\323\344\223\0028\0226/cosmos/feegrant/v1beta1/allowance/{granter}/{grantee}'
    _QUERY.methods_by_name['Allowances']._options = None
    _QUERY.methods_by_name[
        'Allowances'
    ]._serialized_options = b'\202\323\344\223\002/\022-/cosmos/feegrant/v1beta1/allowances/{grantee}'
    _QUERY.methods_by_name['AllowancesByGranter']._options = None
    _QUERY.methods_by_name[
        'AllowancesByGranter'
    ]._serialized_options = b'\202\323\344\223\002+\022)/cosmos/feegrant/v1beta1/issued/{granter}'
