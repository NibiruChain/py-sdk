...
QueryModuleAccountBalances = _reflection.GeneratedProtocolMessageType(
...
QueryModuleAccountBalancesResponse = _reflection.GeneratedProtocolMessageType(
...
QueryCirculatingSupplies = _reflection.GeneratedProtocolMessageType(
...
QueryCirculatingSuppliesResponse = _reflection.GeneratedProtocolMessageType(
...
QueryGovToMintStable = _reflection.GeneratedProtocolMessageType(
...
QueryGovToMintStableResponse = _reflection.GeneratedProtocolMessageType(
...
LiquidityRatioInfo = _reflection.GeneratedProtocolMessageType(
    'LiquidityRatioInfo',
    (_message.Message,),
    {
...
QueryLiquidityRatioInfoRequest = _reflection.GeneratedProtocolMessageType(
...
QueryLiquidityRatioInfoResponse = _reflection.GeneratedProtocolMessageType(
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _QUERYMODULEACCOUNTBALANCESRESPONSE.fields_by_name[
        'moduleAccountBalances'
    ]._serialized_options = (
        b'\362\336\037\014yaml:\"coins\"\310\336\037\000\252\337\037(github.com/cosmos/cosmos-sdk/types.Coins'
    )
    ...
    _LIQUIDITYRATIOINFO.fields_by_name[
        'liquidity_ratio'
    ...
    _QUERY.methods_by_name[
        'ModuleAccountBalances'
    ]._serialized_options = b'\202\323\344\223\002+\022)/nibiru/stablecoin/module_account_balance'
    _QUERY.methods_by_name['CirculatingSupplies']._options = None
    _QUERY.methods_by_name[
        'CirculatingSupplies'
    ]._serialized_options = b'\202\323\344\223\002)\022\'/nibiru/stablecoin/circulating_supplies'
    _QUERY.methods_by_name['LiquidityRatioInfo']._options = None
    _QUERY.methods_by_name[
        'LiquidityRatioInfo'
    ]._serialized_options = b'\202\323\344\223\002)\022\'/nibiru/stablecoin/liquidity_ratio_info'
