...
import grpc
from incentivization.v1 import (
    incentivization_pb2 as incentivization_dot_v1_dot_incentivization__pb2,
)
...
def add_MsgServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler('nibiru.incentivization.v1.Msg', rpc_method_handlers)
...
def add_QueryServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler('nibiru.incentivization.v1.Query', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
