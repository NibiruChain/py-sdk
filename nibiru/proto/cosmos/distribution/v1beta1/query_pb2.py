...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _QUERY.methods_by_name[
        'Params'
    ]._serialized_options = b'\202\323\344\223\002%\022#/cosmos/distribution/v1beta1/params'
    _QUERY.methods_by_name['ValidatorOutstandingRewards']._options = None
    _QUERY.methods_by_name[
        'ValidatorOutstandingRewards'
    ]._serialized_options = (
        b'\202\323\344\223\002Q\022O/cosmos/distribution/v1beta1/validators/{validator_address}/outstanding_rewards'
    )
    _QUERY.methods_by_name['ValidatorCommission']._options = None
    _QUERY.methods_by_name[
        'ValidatorCommission'
    ]._serialized_options = (
        b'\202\323\344\223\002H\022F/cosmos/distribution/v1beta1/validators/{validator_address}/commission'
    )
    _QUERY.methods_by_name['ValidatorSlashes']._options = None
    _QUERY.methods_by_name[
        'ValidatorSlashes'
    ]._serialized_options = (
        b'\202\323\344\223\002E\022C/cosmos/distribution/v1beta1/validators/{validator_address}/slashes'
    )
    _QUERY.methods_by_name['DelegationRewards']._options = None
    _QUERY.methods_by_name[
        'DelegationRewards'
    ]._serialized_options = b'\202\323\344\223\002Y\022W/cosmos/distribution/v1beta1/delegators/{delegator_address}/rewards/{validator_address}'
    _QUERY.methods_by_name['DelegationTotalRewards']._options = None
    _QUERY.methods_by_name[
        'DelegationTotalRewards'
    ]._serialized_options = (
        b'\202\323\344\223\002E\022C/cosmos/distribution/v1beta1/delegators/{delegator_address}/rewards'
    )
    _QUERY.methods_by_name['DelegatorValidators']._options = None
    _QUERY.methods_by_name[
        'DelegatorValidators'
    ]._serialized_options = (
        b'\202\323\344\223\002H\022F/cosmos/distribution/v1beta1/delegators/{delegator_address}/validators'
    )
    _QUERY.methods_by_name['DelegatorWithdrawAddress']._options = None
    _QUERY.methods_by_name[
        'DelegatorWithdrawAddress'
    ]._serialized_options = (
        b'\202\323\344\223\002N\022L/cosmos/distribution/v1beta1/delegators/{delegator_address}/withdraw_address'
    )
    _QUERY.methods_by_name['CommunityPool']._options = None
    _QUERY.methods_by_name[
        'CommunityPool'
    ]._serialized_options = b'\202\323\344\223\002-\022+/cosmos/distribution/v1beta1/community_pool'
