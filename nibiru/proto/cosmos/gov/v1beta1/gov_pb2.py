...
WeightedVoteOption = _reflection.GeneratedProtocolMessageType(
    'WeightedVoteOption',
    (_message.Message,),
    {
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    DESCRIPTOR._serialized_options = (
        b'Z(github.com/cosmos/cosmos-sdk/x/gov/types\330\341\036\000\200\342\036\000\310\341\036\000'
    )
    ...
    _PROPOSALSTATUS.values_by_name[
        "PROPOSAL_STATUS_DEPOSIT_PERIOD"
    ]._serialized_options = b'\212\235 \023StatusDepositPeriod'
    _PROPOSALSTATUS.values_by_name["PROPOSAL_STATUS_VOTING_PERIOD"]._options = None
    _PROPOSALSTATUS.values_by_name[
        "PROPOSAL_STATUS_VOTING_PERIOD"
    ]._serialized_options = b'\212\235 \022StatusVotingPeriod'
    ...
    _WEIGHTEDVOTEOPTION.fields_by_name[
        ...
        b'\332\336\037&github.com/cosmos/cosmos-sdk/types.Dec\310\336\037\000\362\336\037\ryaml:\"weight\"'
    )
    ...
    _PROPOSAL.fields_by_name[
        'final_tally_result'
    ]._serialized_options = b'\310\336\037\000\362\336\037\031yaml:\"final_tally_result\"'
    _PROPOSAL.fields_by_name['submit_time']._options = None
    _PROPOSAL.fields_by_name[
        'submit_time'
    ]._serialized_options = b'\220\337\037\001\310\336\037\000\362\336\037\022yaml:\"submit_time\"'
    _PROPOSAL.fields_by_name['deposit_end_time']._options = None
    _PROPOSAL.fields_by_name[
        'deposit_end_time'
    ]._serialized_options = b'\220\337\037\001\310\336\037\000\362\336\037\027yaml:\"deposit_end_time\"'
    _PROPOSAL.fields_by_name['total_deposit']._options = None
    _PROPOSAL.fields_by_name[
        'total_deposit'
    ]._serialized_options = (
        b'\310\336\037\000\252\337\037(github.com/cosmos/cosmos-sdk/types.Coins\362\336\037\024yaml:\"total_deposit\"'
    )
    _PROPOSAL.fields_by_name['voting_start_time']._options = None
    _PROPOSAL.fields_by_name[
        'voting_start_time'
    ]._serialized_options = b'\220\337\037\001\310\336\037\000\362\336\037\030yaml:\"voting_start_time\"'
    _PROPOSAL.fields_by_name['voting_end_time']._options = None
    _PROPOSAL.fields_by_name[
        'voting_end_time'
    ]._serialized_options = b'\220\337\037\001\310\336\037\000\362\336\037\026yaml:\"voting_end_time\"'
    _PROPOSAL._options = None
    _PROPOSAL._serialized_options = b'\350\240\037\001'
    _TALLYRESULT.fields_by_name['yes']._options = None
    _TALLYRESULT.fields_by_name[
        'yes'
    ...
    _TALLYRESULT.fields_by_name[
        ...
        b'\332\336\037&github.com/cosmos/cosmos-sdk/types.Int\310\336\037\000\362\336\037\023yaml:\"no_with_veto\"'
    )
    ...
    _DEPOSITPARAMS.fields_by_name[
        'min_deposit'
    ]._serialized_options = b'\310\336\037\000\252\337\037(github.com/cosmos/cosmos-sdk/types.Coins\362\336\037\022yaml:\"min_deposit\"\352\336\037\025min_deposit,omitempty'
    _DEPOSITPARAMS.fields_by_name['max_deposit_period']._options = None
    _DEPOSITPARAMS.fields_by_name[
        'max_deposit_period'
    ]._serialized_options = b'\310\336\037\000\230\337\037\001\352\336\037\034max_deposit_period,omitempty\362\336\037\031yaml:\"max_deposit_period\"'
    _VOTINGPARAMS.fields_by_name['voting_period']._options = None
    _VOTINGPARAMS.fields_by_name[
        'voting_period'
    ]._serialized_options = (
        b'\310\336\037\000\230\337\037\001\352\336\037\027voting_period,omitempty\362\336\037\024yaml:\"voting_period\"'
    )
    _TALLYPARAMS.fields_by_name['quorum']._options = None
    _TALLYPARAMS.fields_by_name[
        'quorum'
    ]._serialized_options = (
        b'\332\336\037&github.com/cosmos/cosmos-sdk/types.Dec\310\336\037\000\352\336\037\020quorum,omitempty'
    )
    _TALLYPARAMS.fields_by_name['threshold']._options = None
    _TALLYPARAMS.fields_by_name[
        'threshold'
    ]._serialized_options = (
        b'\332\336\037&github.com/cosmos/cosmos-sdk/types.Dec\310\336\037\000\352\336\037\023threshold,omitempty'
    )
    _TALLYPARAMS.fields_by_name['veto_threshold']._options = None
    _TALLYPARAMS.fields_by_name[
        'veto_threshold'
    ]._serialized_options = b'\332\336\037&github.com/cosmos/cosmos-sdk/types.Dec\310\336\037\000\352\336\037\030veto_threshold,omitempty\362\336\037\025yaml:\"veto_threshold\"'
