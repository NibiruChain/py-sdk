...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _MSGVERIFYINVARIANT.fields_by_name[
        'invariant_module_name'
    ]._serialized_options = b'\362\336\037\034yaml:\"invariant_module_name\"'
    _MSGVERIFYINVARIANT.fields_by_name['invariant_route']._options = None
    _MSGVERIFYINVARIANT.fields_by_name[
        'invariant_route'
    ]._serialized_options = b'\362\336\037\026yaml:\"invariant_route\"'
