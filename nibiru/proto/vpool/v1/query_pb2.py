...
QueryReserveAssetsRequest = _reflection.GeneratedProtocolMessageType(
...
QueryReserveAssetsResponse = _reflection.GeneratedProtocolMessageType(
...
QueryAllPoolsRequest = _reflection.GeneratedProtocolMessageType(
...
QueryAllPoolsResponse = _reflection.GeneratedProtocolMessageType(
...
QueryBaseAssetPriceRequest = _reflection.GeneratedProtocolMessageType(
...
QueryBaseAssetPriceResponse = _reflection.GeneratedProtocolMessageType(
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _QUERYRESERVEASSETSRESPONSE.fields_by_name[
        'base_asset_reserve'
    ...
    _QUERYBASEASSETPRICEREQUEST.fields_by_name[
        'base_asset_amount'
    ]._serialized_options = b'\332\336\037&github.com/cosmos/cosmos-sdk/types.Dec\310\336\037\000'
    _QUERYBASEASSETPRICERESPONSE.fields_by_name['price_in_quote_denom']._options = None
    _QUERYBASEASSETPRICERESPONSE.fields_by_name[
        'price_in_quote_denom'
    ]._serialized_options = b'\332\336\037&github.com/cosmos/cosmos-sdk/types.Dec\310\336\037\000'
    _QUERY.methods_by_name['ReserveAssets']._options = None
    _QUERY.methods_by_name[
        'ReserveAssets'
    ]._serialized_options = b'\202\323\344\223\002\036\022\034/nibiru/vpool/reserve_assets'
    ...
    _QUERY.methods_by_name[
        'BaseAssetPrice'
    ]._serialized_options = b'\202\323\344\223\002 \022\036/nibiru/vpool/base_asset_price'
