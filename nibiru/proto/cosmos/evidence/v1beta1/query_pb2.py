...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _QUERYEVIDENCEREQUEST.fields_by_name[
        'evidence_hash'
    ]._serialized_options = b'\372\336\0374github.com/tendermint/tendermint/libs/bytes.HexBytes'
    _QUERY.methods_by_name['Evidence']._options = None
    _QUERY.methods_by_name[
        'Evidence'
    ]._serialized_options = b'\202\323\344\223\0023\0221/cosmos/evidence/v1beta1/evidence/{evidence_hash}'
    _QUERY.methods_by_name['AllEvidence']._options = None
    _QUERY.methods_by_name[
        'AllEvidence'
    ]._serialized_options = b'\202\323\344\223\002#\022!/cosmos/evidence/v1beta1/evidence'
