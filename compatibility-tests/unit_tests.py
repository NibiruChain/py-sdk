...
#         'http://staking-lcd-testnet.nibiru.network/txs', data=tx_json,
...
#     with grpc.insecure_channel('testnet-sentry0.nibiru.network:9910') as channel:
