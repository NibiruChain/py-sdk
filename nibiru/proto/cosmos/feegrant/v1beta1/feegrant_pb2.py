...
BasicAllowance = _reflection.GeneratedProtocolMessageType(
    'BasicAllowance',
    (_message.Message,),
    {
...
PeriodicAllowance = _reflection.GeneratedProtocolMessageType(
    'PeriodicAllowance',
    (_message.Message,),
    {
...
AllowedMsgAllowance = _reflection.GeneratedProtocolMessageType(
    'AllowedMsgAllowance',
    (_message.Message,),
    {
...
Grant = _reflection.GeneratedProtocolMessageType(
    'Grant',
    (_message.Message,),
    {
        'DESCRIPTOR': _GRANT,
